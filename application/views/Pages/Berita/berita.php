...
<div id="wrapper">
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <a href="<?=site_url('berita/tambah')?>" class="btn btn-primary"><i class="fa fa-plus fa-fw"></i>Tambah</a>
      </div>
    </div>
    <br>
    <div class="row">
...
<script type="text/javascript">
  ...
  function hapus(){
    ...
    $.ajax({
      url : "<?php echo site_url('berita/delete/')?>" + idHapus,
      type: "POST",
